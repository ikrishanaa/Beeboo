...
android {
    ...
    defaultConfig {
        applicationId = "com.ikrishanaa.beeboo"
        minSdk = 24
        targetSdk = 35
    ...
    buildTypes {
        ...
        debug {
            ...
            resValue("string", "app_name", "BeeBoo Debug")
        }
    }
    ...
    productFlavors {
        ...
        create("githubPreview") {
            ...
            resValue("string", "app_name", "BeeBoo Preview")
        }
    ...
    applicationVariants.all {
        outputs.all {
            (this as com.android.build.gradle.internal.api.BaseVariantOutputImpl).outputFileName =
                "BeeBoo-${defaultConfig.versionName}-${name}.apk"
        }
    }
