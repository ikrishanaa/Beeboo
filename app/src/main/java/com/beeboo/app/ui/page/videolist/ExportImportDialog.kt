...
import com.beeboo.app.database.backup.BackupUtil.BackupDestination
import com.beeboo.app.database.backup.BackupUtil.BackupType
import com.beeboo.app.ui.component.DialogSubtitle
import com.beeboo.app.ui.component.BeeBooDialog
import com.beeboo.app.ui.component.SingleSelectChip
...
private fun PreviewExport() {
    BeeBooTheme { ExportDialog() { _, _ -> } }
}

@Preview(uiMode = Configuration.UI_MODE_NIGHT_YES, name = "Dark")
@Composable
private fun PreviewImport() {
    BeeBooTheme { ImportDialog() { _ -> } }
}
