package com.beeboo.app.ui.page.settings.troubleshooting
...
import com.beeboo.app.ui.page.settings.BasePreferencePage
import com.beeboo.app.ui.page.settings.general.YtdlpUpdateChannelDialog
        ...
        LazyColumn(contentPadding = it) {
            item {
                OutlinedCard(modifier = Modifier.padding(16.dp)) {
                    ...
                    val knownIssueUrlBeeBoo = "https://github.com/ikrishanaa/Beeboo/issues"
                    PreferenceItem(
                        title = "BeeBoo Issue Tracker",
                        description = null,
                        icon = Icons.AutoMirrored.Outlined.OpenInNew,
                        onClick = { uriHandler.openUri(knownIssueUrlBeeBoo) },
                    )
