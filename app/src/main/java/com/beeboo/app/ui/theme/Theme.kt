package com.beeboo.app.ui.theme
...
@Composable
@Deprecated("Use BeeBooTheme instead", replaceWith = ReplaceWith("BeeBooTheme(content)"))
fun PreviewThemeLight(content: @Composable () -> Unit) {
    BeeBooTheme(darkTheme = false, content = content)
}
